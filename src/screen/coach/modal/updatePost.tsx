...
import {add_post, update_post} from '../../../redux/feature/featuresSlice';
import {useDispatch, useSelector} from 'react-redux';
import { errorToast } from '../../../configs/customToast';

const UpdatePost = ({visible, onClose, data}) => {
  ...
  const Update_post = async () => {
    ...
    onClose();
    await dispatch(update_post(params));
  };
