...
import { get_event_details } from '../../redux/feature/featuresSlice';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View>
          <Text style={styles.sectionTitle}>{eventdetails?.event_name}</Text>
        ...
        <View style={styles.sectionContainer}>
          <Image
            ...
            style={styles.sectionIcon}
          />
          <Text style={styles.sectionText}>{eventdetails?.event_location}</Text>
        </View>
        <View style={styles.sectionContainer}>
          <Image
