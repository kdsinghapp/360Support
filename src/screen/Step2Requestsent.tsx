    ...
    import {
      ...
      <View
         ...
         <View style={{backgroundColor:'rgb(224, 194, 148)',paddingHorizontal:10,paddingVertical:2,borderRadius:30}}>
            <Text  style={{
               fontSize: 14,
               lineHeight: 19.09,
               fontWeight: '600',
         ...
         <View style={{backgroundColor:'rgb(152, 187, 227)',
         flexDirection:'row',alignItems:'center',marginLeft:10,opacity: 0.8,
         padding:10,borderRadius:5}}>
            <View style={{height:5,width:5,backgroundColor:'#4597f5',borderRadius:2.5,marginHorizontal:2}} />
            <View style={{height:5,width:5,backgroundColor:'#4597f5',borderRadius:2.5,marginHorizontal:2}} />
            <View style={{height:5,width:5,backgroundColor:'#4597f5',borderRadius:2.5,marginHorizontal:2}} />
         </View>
       </View>
